...
public class Echequier {
	...
	public Echequier(){
		...
		// this.matrice.get(0).add(new Tour(1));
		// this.matrice.get(0).add(new Cavalier(1));
		// this.matrice.get(0).add(new Fou(1));
		// this.matrice.get(0).add(new Dame(1));
		// this.matrice.get(0).add(new Roi(1));
		// this.matrice.get(0).add(new Fou(1));
		// this.matrice.get(0).add(new Cavalier(1));
		// this.matrice.get(0).add(new Tour(1));

		// for (int i = 0; i < 8; i++)
		// 	this.matrice.get(1).add(new Pion(1)); // placement des pions blanc
		...
		// for (int i = 0; i < 8; i++) 
		// 	this.matrice.get(6).add(new Pion(0)); // placement des pions noir

		// this.matrice.get(7).add(new Tour(0));
		// this.matrice.get(7).add(new Cavalier(0));
		// this.matrice.get(7).add(new Fou(0));
		// this.matrice.get(7).add(new Dame(0));
		// this.matrice.get(7).add(new Roi(0));
		// this.matrice.get(7).add(new Fou(0));
		// this.matrice.get(7).add(new Cavalier(0));
		// this.matrice.get(7).add(new Tour(0));
